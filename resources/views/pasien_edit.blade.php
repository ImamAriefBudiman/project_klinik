    ...
    <div class="card-body">
        ...
        <form action="/pasien/{{ $pasien->id }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mt-1 mb-3">
                ...
                <input type="file" class="form-control @error('foto') is-invalid @enderror" name="foto"> <span
                    class="text-danger">{{ $errors->first('foto') }}</span>
            ...
            <div class="form-group mt-1 mb-3">
                ...
                <input type="text" class="form-control @error('no pasien') is-invalid @enderror" id="no_pasien"
            ...
            <div class="form-group mt-1 mb-3">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="jenis_kelamin" id="laki_laki" value="laki-laki"
                        {{ old('jenis_kelamin') ?? $pasien->jenis_kelamin === 'laki-laki' ? 'checked' : '' }}> <label
                ...
                <div class="form-check form-check-inline">
                    ...
                    <input class="form-check-input" type="radio" name="jenis kelamin" id="perempuan" value="perempuan"
                        {{ old('jenis_kelamin') ?? $pasien->jenis_kelamin ==='perempuan' ? 'checked' : '' }}><label class="form-check-label"
