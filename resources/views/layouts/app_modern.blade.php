...
<head>
  ...
  <link rel="shortcut icon" type="modern/src/image/png" href="modern/src/assets/images/logos/favicon.png" />
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                  <div class="message-body">
                    ...
                    document.getElementById('logout-form').submit();"
                      class="d-flex align-items-center gap-2 dropdown-item">LogOut
                    </a>
